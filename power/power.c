...
#define SAMPLING_DOWN_FACTOR "100000"
#define MIN_SAMPLE_TIME "60000"

#define IO_IS_BUSY "1"
#define BOOSTPULSE_DURATION "60000"
...
static void set_power_profile(int profile)
{
    ...
    case PROFILE_BALANCED:
        ...
        sysfs_write(INTERACTIVE_PATH "boostpulse_duration", BOOSTPULSE_DURATION);
        sysfs_write(INTERACTIVE_PATH "go_hispeed_load", GO_HISPEED_LOAD);
        sysfs_write(INTERACTIVE_PATH "hispeed_freq", HISPEED_FREQ);
        sysfs_write(INTERACTIVE_PATH "io_is_busy", IO_IS_BUSY);
        sysfs_write(INTERACTIVE_PATH "min_sample_time", MIN_SAMPLE_TIME);
        sysfs_write(INTERACTIVE_PATH "sampling_down_factor", SAMPLING_DOWN_FACTOR);
        sysfs_write(INTERACTIVE_PATH "target_loads", TARGET_LOADS);
